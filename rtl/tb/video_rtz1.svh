...
task load_kreg();
    // KING BG
    io_sel = MMC;
    reg_write(7'h10, 16'h0033); // Mode
    reg_write(7'h12, 16'h0023); // Prio
    reg_write(7'h16, 16'h0003); // ScrM
    // KBG0
    reg_write(7'h2c, 16'h8989); // Size
    ...
    reg_write(7'h42, 16'h0000); // RSTART
    reg_write(7'h43, 16'h0000); // RCOUNT
    reg_write(7'h44, 16'h0000); // RIRQLINE
    reg_write(7'h40, 16'h0000); // RTCTRL
    // MPROG
    reg_write(7'h13, 16'h0000); // uAddr=0
    reg_write(7'h14, 16'h0000); // 0
    reg_write(7'h14, 16'h0001); // 1
    reg_write(7'h14, 16'h0002); // 2
    reg_write(7'h14, 16'h0003); // 3
    reg_write(7'h14, 16'h0040); // 4
    reg_write(7'h14, 16'h0041); // 5
    reg_write(7'h14, 16'h0042); // 6
    reg_write(7'h14, 16'h0043); // 7
    reg_write(7'h14, 16'h0100); // 8
    reg_write(7'h14, 16'h0100); // 9
    reg_write(7'h14, 16'h0100); // A
    reg_write(7'h14, 16'h0100); // B
    reg_write(7'h14, 16'h0100); // C
    reg_write(7'h14, 16'h0100); // D
    reg_write(7'h14, 16'h0100); // E
    reg_write(7'h14, 16'h0100); // F
...
task load_vmem();
    $readmemh("vce_cp-rtz1.hex", vce.cpram.mem);
    vram_load_file("kram0-rtz1.bin", 0);
endtask
