// PC-FX boot video, test 3 (first iDCT frame)
...
task load_kreg();
    ...
    // RAINBOW
    reg32_write(7'h41, 32'h00004000); // RKRAMA
...
task load_vmem();
    $readmemh("vce_cp-bootvid3.hex", vce.cpram.mem);
    vram_load_file("kram0-bootvid3.bin", 0);
    //vram_load_file("kram1-bootvid2.bin", 1);
endtask
