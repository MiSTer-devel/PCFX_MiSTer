// Return To Zork, video frame, first globe appearance
...
task load_kreg();
    ...
    // RAINBOW
    reg32_write(7'h41, 32'h0003C000); // RKRAMA
...
task load_vmem();
`ifdef TB_VDC
    $readmemh("vram0-rtz2.hex", vram0.mem);
    $readmemh("vram1-rtz2.hex", vram1.mem);
`endif
    $readmemh("vce_cp-rtz2.hex", vce.cpram.mem);
    vram_load_file("kram0-rtz4.bin", 0);
    vram_load_file("kram1-rtz4.bin", 1);
endtask
