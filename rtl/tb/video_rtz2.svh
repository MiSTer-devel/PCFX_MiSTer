// Return To Zork, top of mountain

task load_vce_reg();
    io_sel = VCE;
    reg_write(7'h00, 16'h0f00); // CR
...
task load_vdc1_reg();
    ...
    reg_write(7'h06, 16'h0000); // RCR
    reg_write(7'h07, 16'h0328); // BXR
    reg_write(7'h08, 16'h0137); // BYR
    reg_write(7'h09, 16'h0000); // MWR
    reg_write(7'h0a, 16'h0202); // HSR
    reg_write(7'h0b, 16'h041f); // HDR
    reg_write(7'h0c, 16'h1102); // VPR
...
`endif
    ...
    vram_load_file("kram0-rtz2.bin", 0);
    vram_load_file("kram1-rtz2.bin", 1);
endtask
